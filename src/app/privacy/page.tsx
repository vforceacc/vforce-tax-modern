    ...
    <div className="bg-vforce-primary min-h-screen pt-48 pb-32 text-vforce-charcoal">
      <div className="max-w-4xl mx-auto px-6 lg:px-12">
        ...
        <div className="prose max-w-none text-vforce-charcoal">
          ...
          <h2 className="text-vforce-navy text-2xl font-bold mt-8 mb-4">1. Information We Collect</h2>
          ...
          <h2 className="text-vforce-navy text-2xl font-bold mt-8 mb-4">2. How We Use Information</h2>
          ...
          <h2 className="text-vforce-navy text-2xl font-bold mt-8 mb-4">3. Data Security</h2>
