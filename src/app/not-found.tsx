...
export default function NotFound() {
  return (
    <div className="bg-[#0a0f1e] min-h-screen text-white flex flex-col">
      <Navbar />
      <main className="flex-grow max-w-7xl mx-auto px-6 lg:px-12 flex flex-col items-center justify-center py-32 text-center relative overflow-hidden">
        {/* Background Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#39d237]/10 blur-[120px] rounded-full pointer-events-none"></div>
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center text-[#39d237] font-black tracking-[0.3em] uppercase text-[10px] mb-8">
            <span className="w-8 h-[1px] bg-[#39d237] mr-4"></span> Error Code
          </div>
